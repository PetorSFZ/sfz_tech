...
inline DXGI_FORMAT zgToDxgiTextureFormat(ZgFormat format) noexcept
{
	switch (format) {
	case ZG_FORMAT_R_U8_UNORM: return DXGI_FORMAT_R8_UNORM;
	case ZG_FORMAT_RG_U8_UNORM: return DXGI_FORMAT_R8G8_UNORM;
	case ZG_FORMAT_RGBA_U8_UNORM: return DXGI_FORMAT_R8G8B8A8_UNORM;

	case ZG_FORMAT_R_U8: return DXGI_FORMAT_R8_UINT;
	...
	case ZG_FORMAT_R_F32: return DXGI_FORMAT_R32_FLOAT;
	case ZG_FORMAT_RG_F32: return DXGI_FORMAT_R32G32_FLOAT;
	case ZG_FORMAT_RGBA_F32: return DXGI_FORMAT_R32G32B32A32_FLOAT;

	case ZG_FORMAT_DEPTH_F32: return DXGI_FORMAT_D32_FLOAT;
